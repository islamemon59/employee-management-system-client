            ...
            <div className="ml-auto flex items-center justify-end lg:ml-0 gap-2 lg:flex-1 lg:p-0">
              {user ? (
                ...
                <>
                  ...
                  <Link
                    to="/login"
                    className="inline-flex items-center justify-center h-8 gap-2 px-3 text-sm font-medium tracking-wide text-white transition duration-300 rounded whitespace-nowrap bg-emerald-700 hover:bg-emerald-600 focus:bg-emerald-700 focus-visible:outline-none disabled:cursor-not-allowed disabled:border-emerald-300 disabled:bg-emerald-300 disabled:shadow-none"
                  >
                    <span>SignIn</span>
                  </Link>
                </>
