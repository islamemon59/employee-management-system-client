      ...
      <div className="max-w-md w-full text-center">
        <div className="flex justify-center mb-6">
          <div className="rounded-full bg-emerald-100 dark:bg-emerald-900 p-4">
            <FiLock className="text-emerald-600 dark:text-emerald-400" size={48} />
          </div>
        </div>
        ...
        <Link
          to="/"
          className="inline-block rounded bg-emerald-600 px-4 py-2 text-white font-semibold shadow hover:bg-emerald-700 dark:hover:bg-emerald-500 transition-colors"
        >
          Go to Home
        </Link>
      </div>
