...
const DashboardNavLinks = () => {
  return (
    <ul className="flex flex-1 flex-col gap-1 py-3">
      ...
      <li className="px-3">
        <NavLink to="/dashboard/workSheet" className="flex items-center gap-3 rounded p-3 text-slate-700 transition-colors hover:bg-teal-50 hover:text-teal-500 focus:bg-teal-50">
